  ...
  options = {
    reply_markup: {
      inline_keyboard: [
        ...
        [
          { text: "Stalk", callback_data: "stalk-" + user_id },
          { text: "comingsoon", callback_data: "coming-" + user_id },
        ],
      ],
    },
  };
...
exports.stalk = async (lol, user_id) => {
  prefix = config.prefix;
  text = `Stalking Menu :

❏ ${prefix}stalkig {username ig}
❏ ${prefix}stalktiktok {username}
❏ ${prefix}stalktwiter
❏ ${prefix}ytchanel 
❏ ${prefix}cekno {no hp +62xxx}
`;
  await lol.editMessageText(text, {
    reply_markup: {
      inline_keyboard: [[{ text: "Back", callback_data: "help-" + user_id }]],
    },
  });
};
...
exports.messageError = async (lol) => {
  await lol.reply(
    `Error! Please report to the [${config.owner}](${config.ownerLink}) about this`,
